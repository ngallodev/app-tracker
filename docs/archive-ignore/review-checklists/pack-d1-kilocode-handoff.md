# Pack D1 Handoff Prompt (KiloCode / GLM-5)
...
- Apply analysis rate-limit policy at endpoint mapping level if supported; otherwise via path-aware middleware/policy.
...
- Existing non-analysis endpoints continue to function.
